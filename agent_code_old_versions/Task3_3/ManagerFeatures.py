...
def state_to_features(self, game_state: dict) -> np.array:
    ...
    self.features = np.append(self.features, np.max(inv_coins, axis=1))
    ...
    self.features = np.append(self.features, np.max(inv_crate_distances * crate_points, axis=1))
    ...
    self.features = np.append(self.features, bomb_here)
    ...
    self.features = np.append(self.features,-(future_explosion_map[player_pos[0], player_pos[1]]-1))
    ...
    if future_explosion_map[player_pos[0], player_pos[1]] == 1:
        ...
        self.features = np.append(self.features, running)
    ...
    self.features = np.append(self.features, danger)


    # append the opponents feature
    features = np.append(features, inv_opponents)
    self.features = np.append(self.features, np.max(inv_opponents, axis=1))
    ...
    features = np.append(features, number_of_coins + 0.1 * number_of_crates + len(others_list) * 5)
    self.features = np.append(self.features, number_of_coins + 0.1 * number_of_crates + len(others_list) * 5)
